...
| `BRANCH <condition> <label>` | Conditionally continue execution from the`.LABEL` called `label` if `condition` is met.                                                                                                                                                                                                                   | `3CAA` where `AA` is the address of `label` in the current page and `C` encodes the condition |
